...
def get(self, row: int, column: int, direction: Tile.Directions) -> CellFrame | None:
...
def get_coords(self, row: int, column: int, direction: Tile.Directions) -> tuple[int, int] | tuple[None, None]:
    match direction:
